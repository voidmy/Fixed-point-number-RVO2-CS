...
namespace Lockstep.Math {
    ...
    public struct LFloat : IEquatable<LFloat>, IComparable<LFloat> {
        ...
        ////
        ///public static readonly LFloat point1 = new LFloat(true, LFloat.Precision / 10L);
        /** 0.1f */
        public static readonly LFloat point1 = new LFloat(true, LFloat.Precision / 10L);
        /** 0.2f */
        public static readonly LFloat point2 = new LFloat(true, LFloat.Precision * 2 / 10L);
        /** 0.3f */
        public static readonly LFloat point3 = new LFloat(true, LFloat.Precision * 3 / 10L);
        /** 0.4f */
        public static readonly LFloat point4 = new LFloat(true, LFloat.Precision * 4 / 10L);
        /** 0.5f */
        public static readonly LFloat point5 = new LFloat(true, LFloat.Precision * 5 / 10L);
        /** 0.6f */
        public static readonly LFloat point6 = new LFloat(true, LFloat.Precision * 6 / 10L);
        /** 0.7f */
        public static readonly LFloat point7 = new LFloat(true, LFloat.Precision * 7 / 10L);
        /** 0.8f */
        public static readonly LFloat point8 = new LFloat(true, LFloat.Precision * 8 / 10L);
        /** 0.9f */
        public static readonly LFloat point9 = new LFloat(true, LFloat.Precision * 9 / 10L);

        /** -0.1f */
        public static readonly LFloat negPoint1 = new LFloat(true, -LFloat.Precision / 10L);
                                  /* -0.2f */
        public static readonly LFloat negPoint2 = new LFloat(true, -LFloat.Precision * 2 / 10L);
        /** -0.3f */
        public static readonly LFloat negPoint3 = new LFloat(true, -LFloat.Precision * 3 / 10L);
        /** -0.4f */
        public static readonly LFloat negPoint4 = new LFloat(true, -LFloat.Precision * 4 / 10L);
        /** -0.5f */
        public static readonly LFloat negPoint5 = new LFloat(true, -LFloat.Precision * 5 / 10L);
        /** -0.6f */
        public static readonly LFloat negPoint6 = new LFloat(true, -LFloat.Precision * 6 / 10L);
        /** -0.7f */
        public static readonly LFloat negPoint7 = new LFloat(true, -LFloat.Precision * 7 / 10L);
        /** -0.8f */
        public static readonly LFloat negPoint8 = new LFloat(true, -LFloat.Precision * 8 / 10L);
        /** -0.9f */
        public static readonly LFloat negPoint9 = new LFloat(true, -LFloat.Precision * 9 / 10L);
